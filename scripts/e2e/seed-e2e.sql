...
UPDATE users
SET role = 'auditor', is_active = true
...
VALUES
  ...
  (md5('user_e2e_other_tenant')::uuid, 'other-tenant@medfinance.test', '$2a$12$mH/JllR1HHEYeoqF5yKt4evTqGGdXja3X9Ac8T5G9WxPHqU46zKBK', 'Other', 'Tenant', 'finance_manager', md5('org_medfinance_isolated')::uuid, true),
