  ...
  return (
    <div className={styles.page} style={{ maxWidth: 420, margin: '4rem auto' }}>
      ...
      <form onSubmit={submit} style={{ display: 'grid', gap: 12 }} noValidate>
        ...
        <button type="submit" disabled={hasValidationErrors || isSubmitting} style={{ padding: '0.7rem', fontWeight: 600 }}>{isSubmitting ? 'Creating account…' : 'Register'}</button>
